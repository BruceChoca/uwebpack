...
export default {
    ...
    rules: [
      ...
      // It's important to do this before Babel processes the JS.
      {
        ...
        use: [
          {
            options: {
              format: require.resolve('../utils/eslintFormatter'),
  ...
  plugins: [
    ...
    // 自定义插件处理特殊的环境变量.env，包括PUBLIC_URL REACT_APP_xxx
    ...
    // 采用绝对路径进行compile 解决OSX下开发的路径问题
    // 参考：https://www.npmjs.com/package/case-sensitive-paths-webpack-plugin
    new CaseSensitivePathsWebpackPlugin(),
    new WatchMissingNodeModulesPlugin(paths.appNodeModules),
    // 处理momentjs移除不必要的时区和语言引用
